...
Puma::Plugin.create do
  ...
  def start(launcher)
    ...
    @tailwind_pid = fork do
      ...
      begin
        IO.popen([ "bin/rails", "tailwindcss:watch_admin" ], "r+") do |io|
  ...
  private
    ...
    def monitor_puma
      monitor(:puma_dead?, "Detected Puma has gone away, stopping admin tailwind...")
    end

    def monitor_tailwind
      monitor(:tailwind_dead?, "Detected admin tailwind has gone away, stopping Puma...")
    end
